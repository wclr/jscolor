...
var imagesData = {
    arrow: 'data:image/gif;base64,R0lGODlhBwALAKECAAAAAP///6g8eKg8eCH5BAEKAAIALAAAAAAHAAsAAAITTIQYcLnsgGxvijrxqdQq6DRJAQA7',
...
module.exports = {
	...
	color : function(target, prop) {
		...
		function drawPicker(x, y) {
			...
			switch(modeID) {
				case 0: var padImg = imagesData.hs; break;
				case 1: var padImg = imagesData.hv; break;
			}
			p.padM.style.backgroundImage = "url('"+ imagesData.cross + "')";;
			p.padM.style.backgroundRepeat = "no-repeat";
			p.sldM.style.backgroundImage = "url('"+ imagesData.arrow + "')";
